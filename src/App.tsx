  ...
  export default function App() {
    ...
    return (
      <div className="min-h-screen bg-[#f8fafc] font-sans text-slate-900 flex flex-col selection:bg-[#ea580c] selection:text-white">
        ...
        <div id="tra-cuu" className="bg-[#0f172a] relative overflow-hidden min-h-screen flex flex-col pt-28 pb-10">
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-4 text-center w-full flex-grow flex flex-col justify-center">
            <motion.div
            ...
            >
              <div className="bg-white/5 backdrop-blur-sm p-4 rounded-2xl border border-white/10 shadow-[0_0_50px_rgba(255,255,255,0.1)] inline-block">
                <img 
                  src="https://raw.githubusercontent.com/fitallest/Tracking/main/src/image/logovietthai.png" 
                  alt="Minh Thiện Logistics Logo" 
            ...
            <motion.p 
              ...
              className="text-slate-300 text-lg md:text-xl mb-10 max-w-2xl mx-auto font-light leading-relaxed"
            >
            ...
            <motion.form 
              ...
              className="bg-white/10 backdrop-blur-md p-2 sm:p-3 rounded-2xl border border-white/20 shadow-2xl flex flex-col sm:flex-row gap-3 max-w-3xl mx-auto relative z-30 w-full"
            >
              <div className="relative flex-1 flex items-center bg-white rounded-xl overflow-hidden">
                ...
                <input
                  ...
                  className="w-full pl-14 pr-4 py-4 sm:py-5 bg-transparent border-none text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-0 text-base sm:text-lg font-medium"
                  required
                />
              </div>
              <button
            ...
            <motion.div 
              ...
              className="mt-10 flex flex-wrap items-center justify-center gap-4 sm:gap-8 md:gap-12 text-slate-400 text-sm font-medium"
            >
            ...
            <div className="max-w-4xl mx-auto px-4 relative z-10 text-center">
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <a href="#lien-he" className="px-8 py-4 bg-[#ea580c] hover:bg-[#d84d08] text-white font-bold rounded-xl transition-all duration-300 shadow-lg shadow-orange-500/30 hover:shadow-orange-500/50 hover:-translate-y-1 active:scale-95 flex items-center justify-center gap-2 group">
                    Get a Quote <ArrowRight className="w-5 h-5 transform group-hover:translate-x-1 transition-transform" />
                  </a>
                  <a href="tel:0568701182" className="px-8 py-4 bg-white/10 hover:bg-white/20 text-white font-bold rounded-xl transition-all duration-300 backdrop-blur-sm border border-white/20 hover:border-white/40 hover:-translate-y-1 active:scale-95 flex items-center justify-center">
                    Contact Sales
                  </a>
                </div>
              </motion.div>
